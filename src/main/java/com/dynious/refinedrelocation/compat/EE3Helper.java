...
public class EE3Helper {
    ...
    public static void addEE3Recipes() {
        Block alchemicalChest = GameRegistry.findBlock("EE3", "alchemicalChest");
        for (int i = 0; i < 3; i++) {
            GameRegistry.addShapelessRecipe(new ItemStack(alchemicalChest, 1, i), new ItemStack(ModBlocks.sortingAlchemicalChest, 1, i));
        }
    }
