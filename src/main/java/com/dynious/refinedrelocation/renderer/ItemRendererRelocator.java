    ...
    public void render(float x, float y, float z, ItemStack itemStack)
    {
        ...
        for (int side = 0; side < 6; side++)
        {
            ...
            else
            {
                ...
                RendererRelocator.CENTER_MODEL.render(side * 4, 4, trans, iconTransformation, null);
                RendererRelocator.CENTER_MODEL.render(24 + side * 4, 4, trans, iconTransformation, null);
            }
        }
