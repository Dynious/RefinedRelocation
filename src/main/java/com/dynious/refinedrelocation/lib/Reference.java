...
public class Reference
{
    ...
    public static final String DEPENDENCIES = "after:IronChest;after:BuildCraft|Energy;after:IC2;after:CoFHCore;after:JABBA;after:EE3@[0.2.271,);after:appliedenergistics2@[rv1-beta-28,);";
}
