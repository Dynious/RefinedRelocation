...
public class Mods
{
    ...
    public static final boolean IS_BC_TRANS_LOADED = ModAPIManager.INSTANCE.hasAPI("BuildCraftAPI|transport");
    public static final boolean IS_BC_ENERGY_LOADED = ModAPIManager.INSTANCE.hasAPI("BuildCraftAPI|power");
