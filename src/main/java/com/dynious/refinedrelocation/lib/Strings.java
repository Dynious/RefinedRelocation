...
public class Strings
{
    ...
    public static final String FILTERED_EXTRACT_DESC = GUI_PREFIX + "filteredExtrDesc";
    public static final String UNFILTERED_EXTRACT = GUI_PREFIX + "unfilteredExtr";
    public static final String UNFILTERED_EXTRACT_DESC = GUI_PREFIX + "unfilteredExtrDesc";
    ...
    public static final String PLAYER_RELOCATOR_BASE_LOCKED = GUI_PREFIX + "controllerLocked";
    ...
    public static final String POWER_LIMITER = GUI_PREFIX + "powerLimiter";
    public static final String NO_ENERGY_CONNECTION = GUI_PREFIX + "noEnergyConnection";
    public static final String NO_SUITABLE_ENERGY_CONNECTION = GUI_PREFIX + "noSuitableEnergyConnection";
