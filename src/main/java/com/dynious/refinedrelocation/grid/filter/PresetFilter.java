...
public class PresetFilter extends MultiFilterChildBase implements IChecklistFilter
{
    ...
    public void passesFilter(ItemStack itemStack, FilterResult outResult)
    {
        ...
        for (String oreName : oreNames)
        {
            ...
            } else if (presets[1] && oreName.contains("ore"))
            {
                outResult.passes = true;
            }
        ...
        {
            outResult.passes = true;
        } else if (presets[12] && itemStack.getItem() instanceof ItemBlock && Block.getBlockFromItem(itemStack.getItem()) instanceof IPlantable)
        {
            outResult.passes = true;
        }
