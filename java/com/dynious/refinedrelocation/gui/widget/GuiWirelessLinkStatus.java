    ...
    public List<String> getTooltip(int mouseX, int mouseY)
    {
        ...
        if (isMouseInsideBounds(mouseX, mouseY))
        {
            ...
            if (linked)
            {
                ...
                tooltip.add(grayColor + StatCollector.translateToLocal(Strings.TO) + ": " + yellowColor + BlockHelper.getBlockDisplayName(tile.getWorldObj(), tile.xConnected, tile.yConnected, tile.zConnected));
