...
public class Resources
{
    ...
    public static final ResourceLocation MODEL_TEXTURE_ADVANCED_FILTERED_BLOCK_EXTENDER = new ResourceLocation(MOD_ID, MODEL_SHEET_LOCATION + "blockExtender.png");

    public static final String MODEL_BLOCK_EXTENDER = MODEL_LOCATION + "blockExtender2.obj";
}
